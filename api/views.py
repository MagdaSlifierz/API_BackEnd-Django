...
# Create your views here.
# def index(request):
#    # return render(request, 'index.html') this is when you use django as a front end
#    return HttpResponse("it's working") # to thing aabout back edn 
...
#       serializer = ArticleSerializer(artices, many=True)
...
#       seralizer  = ArticleSerializer(article, data=request.data)
#       if seralizer.is_valid():
#          seralizer.save()
#          return Response(seralizer.data, status=status.HTTP_201_CREATED)
#       return Response(seralizer.errors, status=status.HTTP_400_BAD_REQUEST)
...
#       serializer = ArticleSerializer(article)
#       return Response(serializer.data)
#    elif request.method == "PUT": #for updates
